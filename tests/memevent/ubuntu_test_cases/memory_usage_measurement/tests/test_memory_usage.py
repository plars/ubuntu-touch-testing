...
#             self.smem.follow(browser.app.pid, "webbrowser-app")
...
#             self.smem.follow(camera.app.pid, "camera-app")
...
#         #     self.smem.follow(gallery.app.pid, "gallery-app")
...
#         #     self.smem.follow(media_player.app.pid, "media_player-app")
