...
TESTSUITES += [
    ...
    APTest('reminders-autopilot', pkgs=['python3-dbus', 'python3-dbusmock', 'python3-fixtures', 'python3-oauthlib', 'python3-requests-oauthlib', 'account-plugin-evernote-sandbox']),
